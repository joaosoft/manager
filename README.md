...
>### Go
```
go get github.com/joaosoft/go-manager/app
```

## Usage 
This examples are available in the project at [go-manager/example](https://github.com/joaosoft/go-manager/tree/master/example)
